                    ...
                    <div class="col col-lg-8 col-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <input type="text" id="tieude" name="vi_name" class="form-control" placeholder="Tên sản phẩm">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <textarea id="editor" name="vi_body" cols="30" rows="10" style="visibility: hidden; display: none;"></textarea>
                            </div>
                        </div>
                        <div class="panel">
                            <div class="panel-title">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body body_seo" style="display: none;">
                                <div class="form-group">
                                    ...
                                    <textarea id="keywordmeta" name="vi_meta_description" class="form-control" rows="2"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="keywordmeta">Từ khóa Meta</label>
                                    <textarea id="keywordmeta" name="vi_meta_keywords" class="form-control" rows="2"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="seotitle">Tiêu đề SEO</label>
                                    <input type="text" id="seotitle" name="vi_seo_title" class="form-control" placeholder="Tiêu đề SEO">
                                </div>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col col-lg-8 col-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <input type="text" id="tieude" name="en_name" class="form-control" placeholder="Tên sản phẩm">
                                <small class="form-text invalid-feedback"></small>
                            </div>
                        </div>
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <textarea id="editor2" name="en_body" cols="30" rows="10" style="visibility: hidden; display: none;"></textarea>
                            </div>
                        </div>
                        <div class="panel">
                            <div class="panel-title">
                    ...
                    <div class="col col-lg-4 col-12">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body body_seo" style="display: none;">
                                <div class="form-group">
                                    <label for="meta_description">Mô tả Meta</label>
                                    <textarea id="keywordmeta" name="en_meta_description" class="form-control" rows="2"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="keywordmeta">Từ khóa Meta</label>
                                    <textarea id="keywordmeta" name="en_meta_keywords" class="form-control" rows="2"></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="seotitle">Tiêu đề SEO</label>
                                    <input type="text" id="seotitle" name="en_seo_title" class="form-control" placeholder="Tiêu đề SEO">
                                </div>
                            </div>
                        </div>
                        <input type="submit" value="Lưu" class="btn btn-success shadown" style="padding: 6px 20px">
