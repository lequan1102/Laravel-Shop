                    ...
                    <div class="col col-lg-8 col-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <input type="text" placeholder="Tiêu đề" name="vi_title" value="{{ old('vi_title') }}" class="form-control @error('vi_title') is-invalid @enderror">
                                @error('vi_title')
                ...
                <div class="row">
                    <div class="col col-lg-8 col-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <input type="text" placeholder="Tiêu đề" name="en_title" value="{{ old('en_title') }}" class="form-control @error('title') is-invalid @enderror">
                                @error('en_title')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
...
<div class="novi_master">
    <h2>
        ...
        @lang('seeders.data_types.post.add_new')
    </h2>
</div>
@endsection