...
@section('layout')
<form action="{{ route('update.category', ['id' => $edit->id]) }}" method="POST" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="col col-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <input type="text" id="tieude" name="vi_name" class="form-control" placeholder="Tiêu đề" value="{{ $edit->name }}">
                ...
                <div class="row">
                    <div class="col col-12">
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                <label for="tieude">Tên cho chuyên mục</label>
                                <input type="text" id="tieude" name="en_name" class="form-control" placeholder="Tiêu đề" value="{{ $edit->translate('en')->name }}">
                                <small class="form-text invalid-feedback"></small>
                            </div>
                            <div class="panel-body">
                                <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col col-lg-8 col-12">
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        <textarea id="excerpt" name="en_excerpt" class="form-control" rows="2">{{ $edit->translate('en')->excerpt }}</textarea>
                                    </div>
                                </div>
                                <div class="panel">
                                    <div class="panel-title">
                            ...
                            <div class="col col-lg-4 col-12">
                                ...
                                <div class="panel">
                                    ...
                                    <div class="panel-body">
                                        @if ($edit->thumbnail != '')
                                            <input type="text" id="image" name="thumbnail" class="form-control-file dropify" data-allowed-file-extensions="pdf jpg jpeg png" value="{{ $edit->thumbnail }}" data-default-file="{{ $edit->thumbnail }}">
                                            @else
                                                <input type="text" id="image" name="thumbnail" class="form-control-file dropify" data-allowed-file-extensions="pdf jpg jpeg png">
                                        @endif
                                    </div>
...
@section('breadcrumbs')
  {{ Breadcrumbs::render('category_edit', $edit) }}
@endsection
