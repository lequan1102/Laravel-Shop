        ...
        @if (count($question) > 0)
            @foreach ($question as $item)
                ...
                <div class="container-fluid tab-pane active" id="vi">
                    <form action="">
                        <div class="panel">
                            <div class="panel-title" style="border: 1px solid #22a7f0">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="{{ route('destroy.posts', ['id' => $item->id]) }}"><button type="button" class="btn btn-primary">Có! chắc chắn</button></a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
...
@section('novication')
    <div class="novi_master">
        <h2>
            ...
            @lang('backend::seeders.data_types.question.singular')
        </h2>
        <a href="{{ route('create.question') }}" class="btn btn-add" title="Thêm mới bài viết của bạn">
